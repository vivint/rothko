...
// NewWriter makes a Writer that will return distributions using the
...
// Add adds the metric value to the current set of records. It will be
...
// Capture clears out current set of records for future Add calls and
